...
import com.sample.spring.itegration.kafka.configuration.com.sample.spring.integration.kafka.handler.CountDownLatchHandler;
...
public class ConsumingChannelConfig {
  ...
  public ConcurrentMessageListenerContainer<String, String> kafkaListenerContainer() {
    ...
    return (ConcurrentMessageListenerContainer<String, String>) new ConcurrentMessageListenerContainer<>(consumerFactory(), containerProps);
  }
